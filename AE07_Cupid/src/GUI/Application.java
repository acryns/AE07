...
import Backend.PersonDAO;
import Backend.PersonDAOInterface;
import GUI_MVC_REFACTOR.Controller;
import GUI_MVC_REFACTOR.MasterView;
import GUI_MVC_REFACTOR.Model;
...
public class Application extends JFrame {
	...
	public  Application() {
		...
		MasterView view = new MasterView(contentPane);
		PersonDAOInterface dao = new PersonDAO();
		
		Controller controller = new Controller(dao, view, model);
	}
